...
function HeroSection() {
    ...
    useEffect(() => {
        ...
        // Add a timeout to ensure loading state changes even if video fails
        ...
        <>
            ...
            >
                ...
                <div className="hero-titles  md:mt-32 px-4">
                    ...
                    />
                    <div
                        className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-12 mt-10 md:mt-20">
                        <Link
                            to="/Game"
